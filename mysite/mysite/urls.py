...
from bookapi.views import BookViewSet, FictionViewSet, SciFiViewSet, ActionViewSet, MysteryViewSet, HistoricalFictionViewSet, RomanceViewSet, BiographyViewSet, HorrorViewSet, ThrillerViewSet, HistoryViewSet
